  ...
  const icons: { [key: string]: JSX.Element } = {
    ...
    progressDivider: (
      <svg viewBox="0 0 12 20" fill="none" style={iconStyle}>
        <path fillRule="evenodd" clipRule="evenodd" d="M0.0004673 19.3708L10.1857 10L0.0004673 0.650833L0.439083 0L11.3379 10L0.431997 20L0.0004673 19.3708Z" fill="currentColor"/>
      </svg>
    ),
    ...
    // 별 아이콘
    star: (
      <svg fill="currentColor" stroke="currentColor" viewBox="0 0 24 24" style={iconStyle}>
    ...
    truck: (
      <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" style={iconStyle}>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 17a2 2 0 100 4 2 2 0 000-4zM8 17V7a2 2 0 012-2h4.5L19 7.5V17M8 17H6a2 2 0 01-2-2V7a2 2 0 012-2h2" />
      </svg>
    ),
    ...
    question: (
      <svg viewBox="0 0 30 30" fill="none" style={iconStyle}>
        <circle cx="15" cy="15" r="11.25" stroke="currentColor" strokeWidth="2"/>
        <circle cx="15" cy="22.5" r="0.625" fill="currentColor" stroke="currentColor"/>
      </svg>
    ),
    ...
    dropdownArrow: (
      <svg viewBox="0 0 16 10" fill="none" style={iconStyle}>
        <path fillRule="evenodd" clipRule="evenodd" d="M0.503332 -0.000114441L8 8.14809L15.4793 -0.000114441L16 0.350779L8 9.06982L0 0.34511L0.503332 -0.000114441Z" fill="currentColor"/>
      </svg>
    ),
    ...
    arrowRightSmall: (
      <svg viewBox="0 0 10 16" fill="none" style={iconStyle}>
        <path fillRule="evenodd" clipRule="evenodd" d="M0.00037384 15.4967L8.14858 8L0.00037384 0.520667L0.351267 0L9.07031 8L0.345598 16L0.00037384 15.4967Z" fill="currentColor"/>
      </svg>
    ),
    ...
    facebook: (
      <svg viewBox="0 0 11 25" fill="none" style={iconStyle}>
        <path d="M7.07583 24.1504V13.442H10.3017L10.7812 9.24931H7.07583V6.57873C7.07583 5.36888 7.37683 4.54053 8.92733 4.54053H10.892V0.802505C9.93608 0.687778 8.97522 0.632383 8.01383 0.636574C5.1625 0.636574 3.20483 2.58594 3.20483 6.16456V9.24147H0V13.4342H3.21183V24.1504H7.07583Z" fill="currentColor"/>
      </svg>
    ),
